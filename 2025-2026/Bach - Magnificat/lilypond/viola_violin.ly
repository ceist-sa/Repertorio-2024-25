...
\bookpart {
    \header {
        instrument = "Viola (Violino)"
        filename = "VIOLA (VIOLIN) - Bach - Magnificat"
    ...
    \markup{
        \vspace #1
        \justify{Esta partitura contém a parte de viola, mas com as notas transpostas para coincidir com o correspondente no violino, ou seja, tudo está escrito uma quinta acima do que verdadeiramente soa.
        } 
    }
    ...
    \score {
        ...
        \new Staff {
            \transpose fa do' <<\viola_magnificat \clef treble>>
        }
    }
    ...
    \score {
        ...
        \new Staff {
            \transpose fa do' <<\viola_et_exsultavit \clef treble>>
        }
    }
    ...
    \score {
        ...
        \new Staff {
            \transpose fa do' <<\viola_omnes_generationes \clef treble>>
        }
    }
    ...
    \score {
        ...
        \new Staff {
            \transpose fa do' <<\viola_et_misericordia \clef treble>>
        }
    }
    ...
    \score {
        ...
        \new Staff {
            \transpose fa do' <<\viola_fecit_potentiam \clef treble>>
        }
    }
    ...
    \score {
        ...
        \new Staff {
            \transpose fa do' <<\viola_gloria_patri \clef treble>>
        }
    }
}
